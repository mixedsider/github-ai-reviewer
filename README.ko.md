...
PR과 이슈가 생성될 때 AI가 자동으로 코드를 분석하고 댓글을 작성하는 GitHub Actions Reusable Workflow입니다.  
...
> **Organization 단위 일괄 적용:** `Organization → Settings → Secrets and variables → Actions`에서 Organization Secret으로 등록하면 여러 저장소에서 함께 사용할 수 있습니다.
